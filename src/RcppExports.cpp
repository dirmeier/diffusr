...
// do_neighbors
Rcpp::List do_neighbors(const Rcpp::IntegerVector& node_idxs, const Rcpp::NumericMatrix& W, int k, bool use_edge_weights);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< bool >::type use_edge_weights(use_edge_weightsSEXP);
