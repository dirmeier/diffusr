...
Diffusion using *nearest neighbors* is straight-forward. We just traverse through the graph and take all the neighbors of a node until a certain depths in the graph is reached:
